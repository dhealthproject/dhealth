...
import (
	...
	dhealthmodule "github.com/dhealthproject/dhealth/x/dhealth"
	dhealthmodulekeeper "github.com/dhealthproject/dhealth/x/dhealth/keeper"
	dhealthmoduletypes "github.com/dhealthproject/dhealth/x/dhealth/types"
	...
	"github.com/dhealthproject/dhealth/docs"
)

const (
	AccountAddressPrefix = "dh"
	Name                 = "dhealth"
)
...
type App struct {
	*baseapp.BaseApp
	...
	DhealthKeeper dhealthmodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		dhealthmoduletypes.StoreKey, wasmtypes.StoreKey,
	...
	*/
	...
	app.DhealthKeeper = *dhealthmodulekeeper.NewKeeper(
		appCodec,
		keys[dhealthmoduletypes.StoreKey],
		keys[dhealthmoduletypes.MemStoreKey],
		app.GetSubspace(dhealthmoduletypes.ModuleName),
	)
	dhealthModule := dhealthmodule.NewAppModule(appCodec, app.DhealthKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(dhealthmoduletypes.ModuleName)
